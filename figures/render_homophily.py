#!/usr/bin/env python3
"""Render homophily graph illustration (left panel)."""
...
draw_graph(ax, "Homophily (ideal)", seed=42, edge_configs=[
    (0, 1, "-", "H↔H", 2.0, 0.8),
    (1, 2, "-", "H↔H", 2.0, 0.8),
    (6, 7, "-", "B↔B", 2.0, 0.8),
    (7, 8, "-", "B↔B", 2.0, 0.8),
...
fig.tight_layout()
fig.savefig("figures/homophily.svg", facecolor="#0d1117")
print("Saved figures/homophily.svg")
